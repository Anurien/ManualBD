...
public class ConversorResultSetADefaultTableModel {
     ...
     * Vacia el DefaultTableModel completamente y le mete los datos que hay
     * en el ResultSet.
     *
     ...
     * @param modelo El DefaultTableModel que queremos rellenar.
     */
    static void anhadeFilasDeDatos(ResultSet rs,
     ...
     */
    static void vaciaFilasModelo(final DefaultTableModel modelo) {
